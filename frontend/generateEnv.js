...
const apiAuthUrl = `${domain}/api/auth`;

const apiProductsUrl = `${domain}/api/products`;
...
const envContent = `REACT_APP_API_AUTH_URL=${apiAuthUrl}\nREACT_APP_API_PRODUCTS_URL=${apiProductsUrl}\nREACT_APP_API_URL=${postApiBackend}\nREACT_APP_GEMMA_API_URL=${chatApiBackend}\nREACT_APP_IMAGE_UPLOAD_URL=${imageUploadUrl}\n`;
